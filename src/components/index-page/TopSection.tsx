          ...
          <div className="grid lg:grid-cols-[1fr_1.2fr_1fr] gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-[#9c7b6e] text-sm font-light mt-3 max-w-sm">
                30-минутная встреча за 50% от стоимости сессии. Уже на ней я определю, в чём корень проблемы, с чем предстоит работать и какими методами — вы получите чёткий план работы с вариантами дальнейших шагов.
              </p>
            </div>
            {/* Tags */}
            <div>
